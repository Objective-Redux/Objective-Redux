...
import { configureTakeLatest, configureTakeEvery, configureTakeLeading, configureDebounce, configureTake } from '../helpers/effect-type';
...
export declare const actual: {
    ...
    configureTakeLatest: typeof configureTakeLatest;
    configureTakeEvery: typeof configureTakeEvery;
    configureTakeLeading: typeof configureTakeLeading;
    configureDebounce: typeof configureDebounce;
    configureTake: typeof configureTake;
};
